...
function AddContactOpenDrawer({ open, handleClose, item }) {
          ...
          <div className="flex flex-wrap flex-row gap-10 justify-start ml-14">
            ...
            <div className=" w-full h-2/4">
                ...
                <TabsList className="cus-tab-wrap">
                  <TabsTrigger value="Basic Info">Basic & Professional Info</TabsTrigger>
                  <TabsTrigger value="SEO">Address</TabsTrigger>
                  <TabsTrigger value="Social Media Presence">Social Media</TabsTrigger>
                  <TabsTrigger value="Website Analysis">Company</TabsTrigger>
                  <TabsTrigger value="Competitor Analysis">Communication</TabsTrigger>
                  <TabsTrigger value="Target Audience">Product</TabsTrigger>
                  <TabsTrigger value="Goals and Pain">Interested In</TabsTrigger>
                  <TabsTrigger value="Submit Research">Add</TabsTrigger>
...
export default AddContactOpenDrawer;
