...
import ClientResearchTable from "@/components/subcomponents/tables/clientResearchTable";




function ClientResearchComp() {
...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    filterOptions();
    axios
      .get(`${apiPath.prodPath}/api/clients/getClientforResearch`, {
        params : {
          // status : "Lead",
          researchTag : true,
        }
    ...
    <main className="flex flex-col">
      <div className="flex w-full flex-row flex-wrap justify-between">
        <div className="w-full flex flex-row gap-2 mb-[24px] h-[34px]">
          ...
          <h1 className="font-satoshi font-semibold text-2xl ml-[20px]">Client Research</h1>
        </div>
      ...
      <div className="mt-10">
        {loader ? (
          ...
          <ClientResearchTable refreshData={refreshData} allEmp={allEmp}
...
export default ClientResearchComp;
