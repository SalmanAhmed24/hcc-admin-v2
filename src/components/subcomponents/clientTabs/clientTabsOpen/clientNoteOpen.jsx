...
function ClientNoteDetails({ open, handleClose, item }) {
        ...
        <div className="p-10">
          ...
          <div className="flex flex-wrap flex-row gap-4">
            ...
            <div className="w-1/4 flex flex-col gap-2">
              <label className="font-semibold text-xl">Note Category</label>
              <p className="text-md">{item.noteCategory}</p>
            </div>
            <div className="w-1/4 flex flex-col gap-2">
            ...
            <div className="w-1/4 flex flex-col gap-2">
              ...
              <p className="text-md">{item.noteDescription == "" ? "N/A" : item.noteDescription}</p>
            </div>
          </div>
        </div>
      </Drawer>
...
export default ClientNoteDetails;
