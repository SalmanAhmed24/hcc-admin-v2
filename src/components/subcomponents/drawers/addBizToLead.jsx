...
function AddLead({ open, handleClose, editData, }) {
  ...
  useEffect(() => {
    ...
    statusOptions();
    getZipCodes();
      setClientName(editData.storeName);
      setPhone(editData.phone);
      setAddress1(editData.address);
      setCity({label : editData.location.city, value : editData.location.city});
      setState(editData.location.state);
      setZipCode({ label: editData.location.zipcode, value: editData.location.zipcode });
      setWebsiteAddress(editData.bizWebsite);
      setCategory(editData.category);
      setGoogleUrl(editData.googleUrl);
      setPlaceId(editData.placeId);
      setStars(editData.stars);
      setNumberOfReviews(editData.numberOfReviews);
      setRawBody(editData.rawBody);
  ...
  const handleAddClient = (e) => {
    ...
    formData.append("rawBody", rawBody);
    formData.append("query", query);
    formData.append("category", category);
    formData.append("stars", stars);
    formData.append("numberOfReviews", numberOfReviews);
        ...
        <div className="p-10 flex flex-col bg-[#2D245B] flex-wrap">
          ...
          <div className="flex flex-row gap-4 w-full items-center justify-between pb-6 border-b-[1px] border-[#7F56D9]">
            ...
            <div className="flex flex-col gap-2 w-1/4">
             ...
             <div className="flex flex-row gap-4 w-full items-center justify-between pb-6 border-b-[1px] border-[#7F56D9]">
                <div className="flex flex-col gap-2 w-1/3">
                <label className="font-satoshi text-md">Google Url</label>
                <input
                  type="text"
                  className="p-2 border-[#452C95] rounded-[8px] focus-within:outline-none border-[1px] bg-[#191526]"
                  value={googleUrl}
              ...
              <div className="flex flex-col gap-2 w-1/3">
                <label className="font-satoshi text-md">Place Id</label>
                <input
                  type="text"
                  className="p-2 border-[#452C95] rounded-[8px] focus-within:outline-none border-[1px] bg-[#191526]"
                  value={placeId}
              ...
              <div className="flex flex-col gap-2 w-1/3">
                <label className="font-satoshi text-md">Raw Body</label>
                <input
                  type="text"
                  className="p-2 border-[#452C95] rounded-[8px] focus-within:outline-none border-[1px] bg-[#191526]"
                  value={rawBody}
            ...
            <div className="flex flex-row gap-4 w-full items-center justify-between pb-6 border-b-[1px] border-[#7F56D9]">
              <div className="flex flex-col gap-2 w-1/3">
                <label className="font-satoshi text-md">Query</label>
                <input
                  type="text"
                  className="p-2 border-[#452C95] rounded-[8px] focus-within:outline-none border-[1px] bg-[#191526]"
                  value={query}
              ...
              <div className="flex flex-col gap-2 w-1/3">
                <label className="font-satoshi text-md">Stars/Ratings</label>
                <input
                  type="text"
                  className="p-2 border-[#452C95] rounded-[8px] focus-within:outline-none border-[1px] bg-[#191526]"
                  value={stars}
                  onChange={(e) => setStars(e.target.value)}
                  placeholder="Enter Stars/Ratings"
                  name="stars"
                />
              </div>
            </div>
            ...
            <div className="flex flex-row gap-4 w-full items-center justify-between pb-6 border-b-[1px] border-[#7F56D9]">
              <div className="flex flex-col gap-2 w-1/3">
                <label className="font-satoshi text-md">Number of Reviews</label>
                <input
                  type="text"
                  className="p-2 border-[#452C95] rounded-[8px] focus-within:outline-none border-[1px] bg-[#191526]"
