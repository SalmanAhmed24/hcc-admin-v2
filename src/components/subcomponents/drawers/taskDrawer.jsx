...
function TaskNavTab({ open, handleClose }) {
  ...
  const editTask = (data) => {
    axios
      .put(`${apiPath.prodPath}/api/tasks/${taskId}`, data)
      .then((res) => {
        console.log(res);
        refreshData();
      })
        ...
        <div className="p-10">
          <div className="flex flex-row items-center justify-start gap-6 mb-8">
              <ArrowBack
                ...
                onClick={() => handleClose()}
              />
              <h1 className="font-satoshi font-bold text-2xl ">Task Panel</h1>
            </div>
